...
public class BirdController : MonoBehaviour {
    ...
    public delegate void MoveDirectionChangedHandler(BirdController sender, MoveDirectionChangedEventArgs e);
    ...
    private void OnMoveDirectionChanged(BirdController sender, MoveDirectionChangedEventArgs e) {
